...
* @returns {any}
*/
export function process_response(txt) {
    const ret = wasm.process_response(addHeapObject(txt));
...
function getImports() {
    ...
    imports.wbg.__wbg_log_9bb5e574875ce58a = function() { return logError(function (arg0, arg1) {
