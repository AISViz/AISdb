#!/bin/bash
# Benchmark B-Tree vs BRIN (2 weeks - robust version)
# Same approach as 1 week, just loading 14 days

export PGPASSWORD="${PGPASSWORD:-your_password_here}"
CSV_PATH="${CSV_PATH:-/path/to/your/data/202010}"

echo "=========================================="
echo "BENCHMARK: B-TREE vs BRIN (2 WEEKS - ROBUST)"
echo "=========================================="
echo ""
...
DB_BTREE="aisdb_btree_2weeks_robust"
...
DB_BRIN="aisdb_brin_2weeks_robust"
...
# ============================================
# PART 3: LOAD DATA (14 DAYS, WITH VALIDATION)
# ============================================
echo ""
echo "PART 3: Loading data (14 days, with validation)"
echo "================================================="

echo "Processing and validating CSVs (Oct 01-14)..."
