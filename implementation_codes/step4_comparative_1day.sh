#!/bin/bash
# Benchmark B-Tree vs BRIN (robust version)
# With data validation to skip error lines

export PGPASSWORD="${PGPASSWORD:-your_password_here}"
CSV_FILE="${CSV_FILE:-/path/to/your/data/exactEarth_historical_data_2020-10-01.csv}"

echo "=========================================="
echo "BENCHMARK: B-TREE vs BRIN (1 DAY - ROBUST)"
echo "=========================================="
echo ""
...
DB_BTREE="aisdb_btree_1day_robust"
...
DB_BRIN="aisdb_brin_1day_robust"
...
# ============================================
# PART 3: LOAD DATA (WITH VALIDATION)
# ============================================
echo ""
echo "PART 3: Loading data (with validation)"
echo "======================================="

echo "Processing and validating CSV..."
# Criar arquivo temporário limpo
TMP_CSV="/tmp/ais_clean_$(date +%s).csv"
...
echo "✓ B-Tree: $BTREE_TIME seconds"
...
SELECT 
    'Dados (sem índices)' as tipo,
    pg_size_pretty((SELECT data_only FROM chunk_sizes)) as tamanho
UNION ALL
SELECT 
    'Índices (total)',
